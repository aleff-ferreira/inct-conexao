...
values (
  ...
  $json$
  {
    ...
    "criterios": [
      { "key": "plano",     "label": "Coerência do Plano de Trabalho com os EET e objetivos do INCT-CONEXAO", "peso": 6, "max": 60 },
      { "key": "historico", "label": "Histórico Escolar (Coeficiente de Rendimento Acadêmico)",               "peso": 2, "max": 20 },
      { "key": "lattes",    "label": "Produção Acadêmica e Currículo Lattes",                                 "peso": 1, "max": 10 },
      { "key": "video",     "label": "Vídeo de Apresentação/Intenção",                                        "peso": 1, "max": 10 }
    ],
    ...
    "documentos": [
      { "kind": "carta",     "label": "Carta de intenção (até 3.500 caracteres, PDF)" },
      { "kind": "plano",     "label": "Plano de Atividades (até 4.500 caracteres, PDF)" },
      { "kind": "historico", "label": "Histórico escolar + comprovante de matrícula (PDF)" },
      { "kind": "lattes",    "label": "Currículo Lattes atualizado (PDF)" }
    ],
    "estados": [
      { "uf": "RO", "nome": "Rondônia",            "vagas": 17, "instituicoes": "FIOCRUZ RO, UNIR, IFRO, Afya São Lucas, IESPRO, FIMCA, FAAr, FCR, ECOPORÉ, CEPEM, CEMETRON, CCIPWP",
        "orientadores": ["Adnilson de Almeida Silva", "Adriana Cristina da Silva Nunes", "Alexandre de Almeida e Silva", "Anderson Makoto Kayano", "Andreimar Martins Soares", "Angelo Laurence Covatti Terra", "Antônio Laffayete Pires da Silveira", "Arlindo Gonzaga Branco Junior", "Carolina Bioni Garcia Teles", "Chicoepab Suruí Dias", "Dorisvalder Dias Nunes", "Edney Costa Souza", "Elieth Afonso de Mesquita", "Elisabete Lourdes do Nascimento", "Estevão Rafael Fernandes", "Gean Carla da Silva Sganderla", "Graziela Tosini Tejas", "João Paulo Assis Gobo", "Kayena Delaix Zaqueo", "Leidiane Amorim Soares", "Luís Marcelo Aranha Camargo", "Marcela Alvares Oliveira", "Marcela Milrea Araújo Barros", "Marcelo Lucian Ferronato", "Marcos Barros Luiz", "Maria Aurea Pinheiro de Almeida Silveira", "Michel Watanabe", "Mônica Pereira Lima Cunha", "Osvanda Silva de Moura", "Paulo Vilela Cruz", "Rafaela Diniz Sousa", "Reginaldo Martins da Silva de Souza", "Rodrigo Simões Silva", "Ronaldo de Almeida", "Rubiani de Cassia Pagotto", "Saymon de Albuquerque", "Sergio de Almeida Basano", "Sérgio Nunes de Jesus", "Wanderley Rodrigues Bastos", "William Cristian da Silva Pizzaia", "Wilson Gómez Manrique", "Xênia de Castro Barbosa"] },
      { "uf": "RR", "nome": "Roraima",             "vagas": 3,  "instituicoes": "UFRR",
        "orientadores": ["Cléria Mendonça de Moraes", "Fabiana Nakashima", "Gabriel Zazeri"] },
      { "uf": "AM", "nome": "Amazonas",            "vagas": 3,  "instituicoes": "UFAM, FIOCRUZ AM, IFAM",
        "orientadores": ["João Cândido André da Silva Neto", "Juliane Corrêa Glória", "Késsia Caroline Souza Alves", "Luis André Morais Mariúba", "Maria Edilene Martins de Almeida", "Natacha Cintia Regina Aleixo", "Priscila Ferreira de Aquino", "Rafael Ademir Oliveira de Andrade", "Rudson de Jesus Holanda"] },
      { "uf": "PA", "nome": "Pará",                "vagas": 4,  "instituicoes": "UFPA, UFOPA",
        "orientadores": ["Ana Carla dos Santos Gomes", "Consuelo Yumiko Yoshioka e Silva", "Lucas Vaz Peres", "Milton Nascimento da Silva", "Paulo Wender Portal Gomes", "Raphael Pablo Tapajós Silva", "Wandson Braamcamp de Souza Pinheiro"] },
      { "uf": "MA", "nome": "Maranhão",            "vagas": 3,  "instituicoes": "UFMA, UEMA",
      ...
      { "uf": "RN", "nome": "Rio Grande do Norte", "vagas": 1,  "instituicoes": "UFRN",
        "orientadores": ["David Mendes", "Monica Cristina Damião Mendes"] },
