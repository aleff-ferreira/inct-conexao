...
const perfil = [
  "Estar regularmente matriculado(a) em curso de graduação, do 2º ao penúltimo período, em uma das instituições parceiras do INCT-CONEXAO listadas na distribuição das bolsas.",
