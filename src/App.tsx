...
const fundingAgencies = [
  {
    ...
    logo: assetPath("funding-logos/mcti.jpg"),
...
const partnerLogos: Record<string, string> = {
  ...
  UNESP: partnerLogoPath("unesp.svg"),
  ...
  UFRRJ: partnerLogoPath("ufrrj.jpg"),
  ...
  IKIAM: partnerLogoPath("ikiam.svg"),
